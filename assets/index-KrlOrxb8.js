...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function jo(e,t,n){let r=new Float32Array(_o),i=new W(0,1,0);return new fa({name:`SphericalGaussianBlur`,defines:{n:_o,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Po(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Mo(){return new fa({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Po(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function No(){return new fa({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Po(),fragmentShader:`
	...
	`}var Fo=class extends Ln{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Zi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`;function El({techs:e=bl,accentA:t=`#9b87ff`,accentB:n=`#67e8f9`,iconRadius:r=1.4,globeRadius:i=1,fov:a=50,cameraZ:o=3.6,idleSpin:s=.0018,dragSens:c=.0055,momDecay:l=.945,iconSize:u=60,showHint:d=!0,onIconClick:f,className:p=``,style:m}){let h=(0,_.useRef)(null),g=(0,_.useRef)(null),v=(0,_.useRef)(null),y=(0,_.useRef)({scene:null,camera:null,renderer:null,group:null,iconPositions:[],iconEls:[],isDragging:!1,prevX:0,prevY:0,velX:0,velY:0,rafId:0}).current,b=(0,_.useRef)(f);(0,_.useEffect)(()=>{b.current=f},[f]);let[x,S]=(0,_.useState)(!1);return(0,_.useEffect)(()=>{let u=h.current,d=g.current,f=v.current;if(!u||!d||!f)return;let p=new Cr,m=new za(a,1,.1,100);m.position.set(0,0,o);let _=new yl({canvas:d,antialias:!0,alpha:!0,powerPreference:`high-performance`});_.setPixelRatio(Math.min(window.devicePixelRatio,2));let C=new mr;p.add(C);let w=new zi(new ra(i,96,96),new fa({transparent:!0,depthWrite:!1,uniforms:{uColorA:{value:new xr(t)},uColorB:{value:new xr(n)},uOpacity:{value:.85}},vertexShader:Sl,fragmentShader:Cl}));C.add(w),C.add(new zi(new ra(i*.95,32,32),new fa({transparent:!0,depthWrite:!1,blending:2,side:1,uniforms:{uColor:{value:new xr(t)}},vertexShader:wl,fragmentShader:Tl}))),y.scene=p,y.camera=m,y.renderer=_,y.group=C,y.iconPositions=xl(e.length,r),y.iconEls=e.map(e=>{let t=document.createElement(`div`);t.className=`tg-icon`,t.style.setProperty(`--tg-color`,e.color||`#ffffff`),t.dataset.tech=e.name;let n=document.createElement(`img`);n.alt=e.name,n.src=e.url,n.loading=`lazy`,n.draggable=!1,t.appendChild(n);let r=document.createElement(`div`);return r.className=`tg-tooltip`,r.textContent=e.name,t.appendChild(r),f.appendChild(t),t.addEventListener(`pointerenter`,()=>r.classList.add(`show`)),t.addEventListener(`pointerleave`,()=>r.classList.remove(`show`)),t.addEventListener(`click`,()=>b.current?.(e.name,e)),t});let T=()=>{let e=u.clientWidth,t=u.clientHeight;_.setSize(e,t,!1),m.aspect=e/t,m.updateProjectionMatrix()},E=new ResizeObserver(T);E.observe(u),T();let D=e=>{y.isDragging=!0,y.prevX=e.clientX,y.prevY=e.clientY,y.velX=y.velY=0;try{u.setPointerCapture?.(e.pointerId)}catch{}x||S(!0)},O=e=>{if(!y.isDragging)return;let t=e.clientX-y.prevX,n=e.clientY-y.prevY;y.velY=t*c,y.velX=n*c,y.group.rotation.y+=y.velY,y.group.rotation.x+=y.velX,y.prevX=e.clientX,y.prevY=e.clientY},k=e=>{y.isDragging=!1;try{u.releasePointerCapture?.(e.pointerId)}catch{}};u.addEventListener(`pointerdown`,D),window.addEventListener(`pointermove`,O),window.addEventListener(`pointerup`,k),window.addEventListener(`pointercancel`,k);let A=new W,ee=new W,te=new W,j=new W,ne=()=>{y.rafId=requestAnimationFrame(ne);let{group:e,camera:t,iconPositions:n,iconEls:r,isDragging:i}=y;i||(y.velX*=l,y.velY*=l,Math.abs(y.velX)>1e-5&&(e.rotation.x+=y.velX),Math.abs(y.velY)>1e-5&&(e.rotation.y+=y.velY),Math.abs(y.velX)<1e-5&&Math.abs(y.velY)<1e-5&&(e.rotation.y+=s)),e.updateMatrixWorld(!0);let a=u.clientWidth,o=u.clientHeight;for(let i=0;i<n.length;i++){A.copy(n[i]).applyMatrix4(e.matrixWorld),ee.copy(A).normalize(),te.subVectors(t.position,A).normalize();let s=ee.dot(te);j.copy(A).project(t);let c=(j.x*.5+.5)*a,l=(-j.y*.5+.5)*o,u=gn.smoothstep(s,-.5,.55),d=.16+u*.84,f=.6+u*.5,p=r[i];p.style.transform=`translate(${c.toFixed(1)}px, ${l.toFixed(1)}px) translate(-50%, -50%) scale(${f.toFixed(3)})`,p.style.opacity=d.toFixed(3),p.style.setProperty(`--tg-tx`,`${c.toFixed(1)}px`),p.style.setProperty(`--tg-ty`,`${l.toFixed(1)}px`),p.style.zIndex=u>.5?`3`:`2`}_.render(p,t)};return y.rafId=requestAnimationFrame(ne),()=>{cancelAnimationFrame(y.rafId),E.disconnect(),window.removeEventListener(`pointermove`,O),window.removeEventListener(`pointerup`,k),window.removeEventListener(`pointercancel`,k),_.dispose(),p.traverse(e=>{e.geometry&&e.geometry.dispose(),e.material&&(Array.isArray(e.material)?e.material.forEach(e=>e.dispose()):e.material.dispose())}),y.iconEls.forEach(e=>e.remove()),y.iconEls=[],y.iconPositions=[]}},[]),(0,M.jsxs)(`div`,{ref:h,className:`tg-stage ${p}`,style:m,role:`presentation`,tabIndex:-1,children:[(0,M.jsx)(`canvas`,{ref:g,className:`tg-canvas`}),(0,M.jsx)(`div`,{ref:v,className:`tg-icons-layer`}),d&&(0,M.jsx)(`div`,{className:`tg-hint ${x?`tg-hide`:``}`,children:`Drag with your mouse — rotate freely in any direction`})]})}function Dl({theme:e}){return(0,M.jsx)(`section`,{id:`skills`,className:`relative z-10 max-w-7xl mx-auto mt-24 mb-16 px-6 py-16 overflow-hidden`,children:(0,M.jsxs)(`div`,{className:`grid lg:grid-cols-2 gap-12 items-center`,children:[(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`h2`,{className:`text-5xl font-bold`,style:{color:e===`light`?`#0f172a`:`#f8fafc`,fontFamily:`'Lato', sans-serif`},children:`Technologies I Work With`}),(0,M.jsx)(`p`,{className:`mt-6 leading-8`,style:{color:e===`light`?`#475569`:`#cbd5e1`,fontFamily:`'Lato', sans-serif`},children:`I build responsive and modern web applications using React, JavaScript, Tailwind CSS, Node.js, Express, MongoDB, and Firebase. I'm continuously learning new technologies to create better user experiences.`})]}),(0,M.jsx)(`div`,{className:`flex justify-center lg:justify-end w-full`,children:(0,M.jsx)(El,{className:`w-full max-w-[480px] h-auto`,style:{width:`100%`,maxWidth:480,height:`min(80vw, 480px)`,minHeight:320,aspectRatio:`1 / 1`}})})]})})}function Ol({theme:e}){let t=(0,_.useRef)(null);return(0,_.useEffect)(()=>{let n=t.current;if(!n)return;let r=n.getContext(`2d`),i=window.devicePixelRatio||1,a=0,o=0,s,c=null,l={x:0,y:0,active:!1},u=e===`light`,d=.11,f=.105,p=[],m=()=>{p=Array.from({length:240},()=>{let e=Math.random()*a,t=Math.random()*o;return{x:e,y:t,homeX:e,homeY:t,vx:(Math.random()-.5)*d,vy:(Math.random()-.5)*d,radius:Math.random()*1.6+.35,alpha:Math.random()*.26+.12,twinkleOffset:Math.random()*Math.PI*2,twinkleSpeed:Math.random()*.045+.015}})},h=()=>{a=window.innerWidth,o=window.innerHeight,n.width=Math.max(1,Math.floor(a*i)),n.height=Math.max(1,Math.floor(o*i)),r.setTransform(i,0,0,i,0,0),c=n.getBoundingClientRect(),m()},g=e=>{if(!c)return;let t=e.clientX-c.left,n=e.clientY-c.top;l.active=t>=0&&n>=0&&t<=c.width&&n<=c.height,l.x=t,l.y=n},_=()=>{l.active=!1},v=e=>{r.clearRect(0,0,a,o);let t=.92,n=Math.min(a,o)*.16,i=Math.min(180,n);p.forEach(n=>{let s=n.homeX-n.x,c=n.homeY-n.y;if(l.active){let e=n.x-l.x,t=n.y-l.y,r=Math.hypot(e,t);if(r<i&&r>0){let a=(i-r)/i*.5,o=Math.atan2(t,e);n.vx+=Math.cos(o)*a,n.vy+=Math.sin(o)*a}}n.x+=s*f,n.y+=c*f,n.x+=n.vx,n.y+=n.vy,n.x<-20&&(n.x=a+20),n.x>a+20&&(n.x=-20),n.y<-20&&(n.y=o+20),n.y>o+20&&(n.y=-20),n.vx*=t,n.vy*=t;let d=.55+.45*Math.sin(e*.001*n.twinkleSpeed+n.twinkleOffset),p=n.radius*(2.2+d*1.8),m=n.x,h=n.y,g=Math.min(.8,Math.max(.08,n.alpha*.74*(.85+d*.35))),[_,v,y]=u?[15,23,42]:[220,240,255],b=u?.95:1,x=r.createRadialGradient(m,h,0,m,h,p*2.3);x.addColorStop(0,`rgba(${_},${v},${y},${g*b})`),x.addColorStop(.4,`rgba(${_},${v},${y},${g*.42*b})`),x.addColorStop(1,`rgba(255,255,255,0)`),r.save(),r.globalCompositeOperation=u?`source-over`:`screen`,r.fillStyle=x,r.beginPath(),r.arc(m,h,p*2.3,0,Math.PI*2),r.fill(),r.restore()})},y=e=>{v(e),s=requestAnimationFrame(y)};return h(),window.addEventListener(`resize`,h),window.addEventListener(`mousemove`,g),window.addEventListener(`mouseout`,_),s=requestAnimationFrame(y),()=>{window.removeEventListener(`resize`,h),window.removeEventListener(`mousemove`,g),window.removeEventListener(`mouseout`,_),cancelAnimationFrame(s)}},[e]),(0,M.jsx)(`canvas`,{ref:t,className:`particle-bg`,"aria-hidden":`true`})}function kl(){let[e,t]=(0,_.useState)(`dark`);return(0,_.useEffect)(()=>{document.title=`Mobarok Hossen | Portfolio`},[]),(0,M.jsxs)(`div`,{className:`relative isolate min-h-screen overflow-x-hidden transition-colors duration-300`,style:{background:e===`light`?`linear-gradient(135deg, rgba(248, 250, 252, 0.82) 0%, rgba(226, 232, 240, 0.68) 100%)`:`linear-gradient(135deg, rgba(2, 6, 23, 0.98) 0%, rgba(15, 23, 42, 0.94) 100%)`},children:[(0,M.jsx)(Ol,{theme:e}),(0,M.jsxs)(`div`,{className:`relative z-10`,children:[(0,M.jsx)(re,{theme:e,toggleTheme:()=>{t(e=>e===`light`?`dark`:`light`)}}),(0,M.jsx)(P,{theme:e}),(0,M.jsx)(Dl,{theme:e}),(0,M.jsx)(ae,{theme:e}),(0,M.jsx)(se,{theme:e}),(0,M.jsx)(`section`,{id:`contact`,className:`max-w-7xl mx-auto px-6 py-20`,children:(0,M.jsxs)(`div`,{className:`text-center`,children:[(0,M.jsx)(`h2`,{className:`text-5xl font-bold mb-6`,style:{color:e===`light`?`#0f172a`:`#f8fafc`,fontFamily:`'Lato', sans-serif`},children:`Contact`}),(0,M.jsx)(`p`,{className:`max-w-2xl mx-auto leading-8`,style:{color:e===`light`?`#475569`:`#cbd5e1`,fontFamily:`'Lato', sans-serif`},children:`Have a project idea or want to collaborate? Reach out by email or connect with me on your preferred platform.`})]})})]})]})}var Al=new j({duration:1.2,easing:e=>Math.min(1,1.001-2**(-10*e)),smoothWheel:!0,smoothTouch:!1,touchMultiplier:2});function jl(e){Al.raf(e),requestAnimationFrame(jl)}requestAnimationFrame(jl),(0,v.createRoot)(document.getElementById(`root`)).render((0,M.jsx)(_.StrictMode,{children:(0,M.jsx)(kl,{})}));
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 items-stretch">
        ...
        >
          ...
          <div className="card-body flex flex-col flex-1">
            ...
            <div className="card-actions justify-end mt-auto">
              <div
                className={`badge badge-outline text-lg font-semibold ${theme === "light" ? "border-white text-white" : "border-gray-900 text-gray-900"}`}
              >
                Travel
              </div>
              <div
        ...
        >
          ...
          <div className="card-body flex flex-col flex-1">
            ...
            <p className="flex-1">
              This site was designed and developed for a Book selling and
              lending service. It features a responsive design, allowing users
              to easily navigate and access information about various
              book-related services. The site includes a user-friendly
              interface, making it easy for customers to find and contact the
              service.
            </p>
            <div className="card-actions justify-end mt-auto">
              <div
        ...
        >
          ...
          <div className="card-body flex flex-col flex-1">
            ...
            <p className="flex-1">
              This is just a fun project for my own amusement. It was created
              for working in my typing speed. It is alphabet typing game where
              you have to type the alphabet as fast as you can. It features a
              responsive design, allowing users to easily navigate and access
              the game on any device. The site includes a user-friendly
              interface, making it easy for players to enjoy the game and
        ...
        >
          ...
          <div className="card-body flex flex-col flex-1">
            ...
            <p className="flex-1">
              This is a blogging site where people can write their thoughts and
              share with others. It features a responsive design, allowing users
              to easily navigate and access the site on any device. The site
              includes a user-friendly interface, making it easy for users to
              create and share their blog posts with the community.
            </p>
            <div className="card-actions justify-end mt-auto">
              <div
                className={`badge badge-outline text-lg font-semibold ${theme === "light" ? "border-white text-white" : "border-gray-900 text-gray-900"}`}
